...
class CVControl:
    def __init__(self):
        ...
        self.is_recording = False  # 이 부분을 추가합니다.
        self.y_angle = 0
    ...
    def adjust_robot_arm_and_agv(self):
        ...
        while self.step == 40:
            try:
                image_msg = rospy.wait_for_message("/camera/image/compressed", CompressedImage, timeout=5)  # 타임아웃 시간을 늘림
                ...
                if results.pose_landmarks:
                    ...
                    if abs(gap_y) <= 10 and abs(gap_foot_y) <= 10: # 50, 40
                        self.step = 50
