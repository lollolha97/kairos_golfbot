...
class CVControl:
    ...
    def rotate_target(self):
        ...
        if not self.all_landmarks_visible:
            ...
            linear_velocity_y = 0.1  # 원형 경로를 위한 속도 조정
            self.send_command(-0.05, angular_velocity, linear_velocity_y)
    ...
    def move_at_step_thirty(self):
        ...
        while not rospy.is_shutdown():
            ...
            # if self.is_person_detected() and not self.all_landmarks_visible:
    ...
    def adjust_robot_arm_and_agv(self):
        print("Adjusting robot arm and AGV position")
        while self.step == 40:
            try:
    ...
    def camera_callback(self, data):
        ...
        try:
            ...
            if results.pose_landmarks:
                ...
                is_facing_forward = is_facing_forward(results.pose_landmarks.landmark, image.shape[1], image.shape[0])
                all_landmarks_visible = all_landmarks_visible(results.pose_landmarks.landmark)
